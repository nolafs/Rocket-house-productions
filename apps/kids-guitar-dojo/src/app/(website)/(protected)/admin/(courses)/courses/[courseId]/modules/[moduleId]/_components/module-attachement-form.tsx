...
import AttachmentCategoryForm from '../../../_components/attachment-category-form';

interface AttachmentFormProps {
  initialData: Module & { attachments: ModuleAttachment[] };
...
const ModuleAttachmentForm = ({ initialData, courseId, moduleId, attachmentCategories }: AttachmentFormProps) => {
  ...
  const onDelete = async (id: string) => {
    try {
      setDeletingId(id);
      await axios.delete(`/api/courses/${courseId}/modules/${moduleId}/attachments/${id}`);
...
export default ModuleAttachmentForm;
